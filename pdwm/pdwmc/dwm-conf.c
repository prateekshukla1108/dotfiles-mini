...
extern void shiftwindow(const Arg *arg);
extern void killallinstances(const Arg *arg);
#ifndef __OpenBSD__
...
char dmenufont[] = "JetBrains Mono:style=Regular:size=12";
char dmenuh[] = "30";
...
static const char *alacritty_ranger[] = { "alacritty", "--config-file", "/home/prateek/.config/bspwm/alacritty/alacritty.toml", "-e", "ranger", NULL };
static const char *alacritty_htop[] = { "alacritty", "--config-file", "/home/prateek/.config/bspwm/alacritty/alacritty.toml", "-e", "htop", NULL };
static const char *alacritty_bashtop[] = { "alacritty", "--config-file", "/home/prateek/.config/bspwm/alacritty/alacritty.toml", "-e", "bashtop", NULL };
static const char *alacritty_nvim[] = { "alacritty", "--config-file", "/home/prateek/.config/bspwm/alacritty/alacritty.toml", "-e", "nvim", NULL };
static const char *alacritty_vim[] = { "alacritty", "--config-file", "/home/prateek/.config/bspwm/alacritty/alacritty.toml", "-e", "vim", NULL };
